...
// 01 - Filmes de ação lançados entre 2000 e 2003:
...
// 02 - Filmes de comédia ou terror com menos de 2 horas:
db.filmes.find({$or:[{generos:{$in:["Comedy"]}},{generos:{$in:["Horror"]}}],duracao:{$lt:120}}, {_id:0,titulo:1,generos:1,duracao:1})
...
// 04 - Quantos filmes arrecadaram mais de 1 milhão:
...
// 06 - Filmes dirigidos por Steven Spierlberg na década de 90:
...
db.filmes.distinct("diretores", {data_estreia:{$gte:new Date(2005,1,1), $lte:new Date(2005,12,30)}})


// 09 - Quais os atores de filmes de ação e comédia de 2010:
db.filmes.distinct("atores", {generos:{$in:["Action"], $in:["Comedy"]}, data_estreia:{$gte:new Date(2010,1,1), $lte:new Date(2010,12,30) }} )
